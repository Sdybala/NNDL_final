...
class Solver(object):
    ...
    def load_data(self):
        ...
        train_set = torchvision.datasets.CIFAR100(root='./data1', train=True, download=True, transform=train_transform)
        self.train_loader = torch.utils.data.DataLoader(dataset=train_set, batch_size=self.train_batch_size, shuffle=True)
        test_set = torchvision.datasets.CIFAR100(root='./data1', train=False, download=True, transform=test_transform)
